/*
 * wb_i2c_mux_pca954x_device_b3.c
 * CPO build3 i2c-mux-pca9548 topology, fix the 9548 address under the i2c-16 to 0x74
 */
...
static i2c_mux_pca954x_device_t i2c_mux_pca954x_device_data0 = {
    ...
    .attr = {
        ...
        .file_attr.offset           = 0x31,
        .file_attr.mask             = 0x80,
        .file_attr.reset_on         = 0x00,
        .file_attr.reset_off        = 0x80,
    },
};
...
static i2c_mux_pca954x_device_t i2c_mux_pca954x_device_data1 = {
    ...
    .rst_delay_a                    = 1000,
    .attr = {
        .file_attr.dev_name         = "/dev/cpld3",
        .file_attr.offset           = 0x18,
        .file_attr.mask             = 0x01,
        .file_attr.reset_on         = 0x00,
...
static void __exit wb_i2c_mux_pca954x_device_exit(void)
{
    ...
    for (i = ARRAY_SIZE(i2c_mux_pca954x_device_info) - 1; i >= 0; i--) {
        i2c_mux_pca954x_device_data = i2c_mux_pca954x_device_info[i].platform_data;
        i2c_bus = i2c_mux_pca954x_device_data->i2c_bus;
        i2c_addr = i2c_mux_pca954x_device_data->i2c_addr;
        ...
        if (i2c_mux_pca954x_device_data->client) {
            WB_I2C_MUX_PCA954X_DEVICE_DEBUG_VERBOSE("Starting unregister i2c client: %d-%04x\n", i2c_bus, i2c_addr);
            if (device_is_registered(&i2c_mux_pca954x_device_data->client->dev)) {
