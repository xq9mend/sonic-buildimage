...
#define PMBUS_SYSFS_RV_UNSUPPORT     (999)
#define PMBUS_READ_FAIL              "ACCESS FAILED"
#define PMBUS_READ_NO_SUPPORT        "NA"
#define MAX_UNIT_LEN                 (16)
#define DEV_NAME_LEN                 (64)
#define MAX_RW_LEN                   (256)
#define PMBUS_SENSOR_COEFFICIENT     (1000LL) /* Keep three decimal places */
...
typedef enum {
    ...
    STRING_DATA,
    SENSOR_DATA,
    LE_DATA, /* Little Endian Data */
    BE_DATA, /* Big Endian Data */
} pmbus_data_type_t;

typedef struct {
    char pmbus_name[DEV_NAME_LEN];
    uint32_t page_mask;
    int pmbus_reg;
    pmbus_data_width_t width;
    pmbus_data_type_t data_type;
...
enum pmbus_regs {
    ...
    PMBUS_PRI_FW_VER        = 0xDD,
    PMBUS_SEC_FW_VER        = 0xD7,
    PMBUS_MFR_POS_TOTAL     = 0xE5,
    PMBUS_MFR_POS_LAST      = 0xE6,
...
struct pmbus_data {
    ...
    bool is_support_block_read;
    pmbus_info_t *pmbus_info_array;
    int pmbus_info_array_size;
};
...
pmbus_dev_info_t pmbus_dev_infos[] = {
    {.device_name = "wb_xdpe12284", .chip_name = "XDPE12284C", .device_id = {0x79, 0x00}, .dev_id_len = 2},
    {.device_name = "wb_xdpe12284", .chip_name = "XDPE12284C", .device_id = {0x79, 0x01}, .dev_id_len = 2},
    ...
    {.device_name = "wb_isl69260", .chip_name = "ISL69260", .device_id = {0x00, 0x81, 0xd2, 0x49}, .dev_id_len = 4},
};
